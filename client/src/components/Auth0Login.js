...
// let credentials = require('../credentials').auth0;

let lock = new Auth0Lock(credentials.auth0);
...
let TokenView = React.createClass({
  
  render: function() {
    return <View style={styles.tokenContainer}>
...
let LockReactApp = React.createClass({
